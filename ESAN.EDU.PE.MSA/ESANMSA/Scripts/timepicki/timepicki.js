	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			var top_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='prev2 action-prev2'></div>" :
				"<div class='prev2 action-next2'></div>";
			var bottom_arrow_button = (settings.increase_direction === 'down') ?
				"<div class='next2 action-next2'></div>" :
				"<div class='next2 action-prev2'></div>";
			...
			function change_time(cur_ele, direction) {
				...
				if ((cur_ele && cur_ele.hasClass('action-next2')) || direction === 'next2') {
				...
				} else if ((cur_ele && cur_ele.hasClass('action-prev2')) || direction === 'prev2') {
			...
			var cur_next = ele_next.find(".action-next2");
			var cur_prev = ele_next.find(".action-prev2");
